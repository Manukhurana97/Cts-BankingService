...
// Register	
	...
	public ResponseEntity<Response> RegisterUser(@RequestBody GetUserdata myUser) {
		...
		try {
			...
			System.out.println(myUser.getEmail()+" "+myUser.getPassword()+" "+myUser.getPan()+" "+myUser.getConfirmpassword()+" "+myUser.getRole());
//			check for blank data
...
//			Saving additional data
	...
	// Register	
		...
		@HystrixCommand(fallbackMethod = "RegisterFallback")
		public ResponseEntity<Response> RegisterAdmin(@RequestBody GetUserdata myUser) {
